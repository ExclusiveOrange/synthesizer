...
/*----------------
  STATIC FUNCTIONS
  ----------------*/
DSFMT_inline static uint32_t ini_func1(uint32_t x);
DSFMT_inline static uint32_t ini_func2(uint32_t x);
DSFMT_inline static void gen_rand_array_c1o2(dsfmt_t *dsfmt, w128_t *array,
				       int size);
DSFMT_inline static void gen_rand_array_c0o1(dsfmt_t *dsfmt, w128_t *array,
				       int size);
DSFMT_inline static void gen_rand_array_o0c1(dsfmt_t *dsfmt, w128_t *array,
				       int size);
DSFMT_inline static void gen_rand_array_o0o1(dsfmt_t *dsfmt, w128_t *array,
				       int size);
DSFMT_inline static int idxof(int i);
 ...
 */
DSFMT_inline static void convert_c0o1(w128_t *w) {
 ...
 * @param w 128bit stracture of double precision floating point numbers (I/O)
 */
DSFMT_inline static void convert_o0c1(w128_t *w) {
 ...
 * @param w 128bit stracture of double precision floating point numbers (I/O)
 */
DSFMT_inline static void convert_o0o1(w128_t *w) {
